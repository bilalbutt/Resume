...
<div class="w3-container bio_cnt <?php echo SLIDE_IN_LEFT; ?>">
	...
	<?php } ?>
	<p><i class="fas fa-home fa-2x w3-margin-right w3-large1 <?php echo $ThemeTextColor; ?>"></i><?php echo CITY; ?></p>
	<p><i class="far fa-envelope fa-2x w3-margin-right w3-large1 <?php echo $ThemeTextColor; ?>"></i><?php echo EMAIL; ?></p>
	<p><i class="fas fa-mobile-alt fa-2x w3-margin-right w3-large1 <?php echo $ThemeTextColor; ?>"></i><?php echo MOBILE; ?></p>
